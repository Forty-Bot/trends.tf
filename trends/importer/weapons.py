...
def parse_weapons(items):
    ...
    for logname, name, slot in (
        ...
        ('crocodile', "Crocodile", 'environment'),
        ('dragons_fury_bonus', "Dragon's Fury Bonus", 'primary'),
        ('gas_blast', "Gas Blast", 'taunt'),
        ('eyeball_rocket', "MONOCULUS Eye Projectile", 'primary'),
        ('entity_medigun_shield', "Projectile Shield", 'secondary'),
        ('loose_cannon_explosion', "Loose Cannon", 'primary'),
        ('loose_cannon_impact', "Loose Cannon", 'primary'),
        ('loose_cannon_reflect', "Loose Cannon Reflect", 'primary'),
        ...
        ('player', "Suicide", 'environment'),
        ('player_penetration', "Machina Penetration", 'primary'),
        ('prop_physics', "Environment", 'action'),
        ('point_hurt', "Necro Smasher", 'melee'),
        ('rescue_ranger_reflect', "Rescue Ranger Reflect", 'primary'),
